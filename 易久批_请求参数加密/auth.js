...
localStorage = watch({
    local_init_time:new Date()/1000,
    server_init_time:parseInt(new Date()/1000),
...
var xhr_req = {
    "url": "/v58/ProductCategory/CategoryTree",
    "method": "post",
    "data": {
        "data": {
            "type": 1
    ...
    "headers": {
        ...
        "UUID": "74b360272c9d037454361dcfab15c587"
    },
    "transformRequest": [
        null
    ],
...
//直接全扣的 补了2个环境
function get_auth() {
    initInterAuth(xhr_req)
    return JSON.stringify(xhr_req)
}